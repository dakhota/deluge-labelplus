...
class TaggingError(Exception):
  ...
  def __str__(self):
    ...
    from tagging.common.literals import STR_ERROR
...
def extract_error(failure):
  ...
  if (isinstance(failure.value, DelugeRPCError) and
      failure.value.exception_type == "TaggingError"):
    return TaggingError(failure.value.exception_msg)
  else:
    return None
