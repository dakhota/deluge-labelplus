...
CONFIG_DEFAULTS_V1 = {
  "prefs": {
    ...
    "defaults": TAG_DEFAULTS_V1,
  },
  "tags": {},   # "tag_id": {"name": str, "data": dict}
  "mappings": {}, # "torrent_id": "tag_id"
}
...
TAG_DEFAULTS_V2 = {
  ...
  "autotag_settings": False,
  "autotag_match_all": False,
  "autotag_rules": [],
}
...
def init_config(config, defaults, version, specs):
  ...
  while ver != version:
    ...
    spec = specs.get(key)
    if spec:
      tagging.common.config.convert.convert(spec, config)
