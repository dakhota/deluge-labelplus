...
from tagging.gtkui.config import (
  CONFIG_DEFAULTS_V2,
  CONFIG_DEFAULTS_V3,
)
...
CONFIG_SPEC_V1_V2 = {
  ...
  "map": {
    ...
    "tag_options_size": "common/tag_options_size",
    "tag_options_pos": "common/tag_options_pos",

    "prefs_state": "common/prefs_state",

    "show_tag_bandwidth": "common/show_tag_bandwidth",
  },
}
...
CONFIG_SPEC_V2_V3 = {
  ...
  "map": {
    ...
    "common/tag_options_size": "common/tag_options_size",
    "common/tag_options_pos": "common/tag_options_pos",

    "common/prefs_state": "common/prefs_state",

    "common/show_tag_bandwidth": "common/status_bar",
    "common/status_include_subtag": "common/status_bar_include_subtags",
